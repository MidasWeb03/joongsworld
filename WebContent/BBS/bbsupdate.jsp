	...
	<div class="section">	
		...
		<div class="content">
			...
			<table>
				...
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" size="100%" value="<%=bbs.getTitle() %>"/></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="content" rows="20" cols="101" ><%=bbs.getContent() %></textarea></td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" value="글 수정"/>
					<input type="hidden" name="seq" value="<%=bbs.getSeq() %>"/></td>
				</tr>
			</table>
			</form>
		</div>
